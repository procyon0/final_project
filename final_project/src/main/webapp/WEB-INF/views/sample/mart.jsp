...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/mart.css">
    ...
    <div id ="search">
        <form action="ProductDetail.html" method="GET">
...
<body>
    <div id="list_goods">
        <ul>
            <li id="goods" >
                <img src="/resources/img/placeholder.jpg" width="249" height="320">
            <div id="info_goods">
                <p id="title">짱셔요!</p>
                <p id="price">1000원</p>
                <p id="desc">참을수없는 콜라 신맛의 짜릿함 </p>
            </div>
            </li>
        </ul>   
    </div>
