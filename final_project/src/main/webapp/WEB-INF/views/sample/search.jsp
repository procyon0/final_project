...
<body>
    <div id ="search">
        <form action="search.html" method="GET">
            ...
            <input type="search" title="검색" placeholder="입력해주세요.">
            <button>검색</button> 
        </form>
    </div>
    ...
    <div id="block" >
        <div id="img_blo">
            <img src="http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00095_2.png" width=200px; height=200px;>
        </div>
            <div id="content_blo">
                <h2><a>치커리 샐러드와 올리브 마늘 소스</a></h2>
                <br>
                <br>
