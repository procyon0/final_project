...
<body>
    <div id="detail_goods">
              ...
              <div id="test">
                 <div id = "back_block">
                  <button class="back_btn">
                     <a href="/goods/list"><img src="/resources/img/list.png" width="72px" height="72px"></a>
                  </button>
               </div>  
				...
				<div id="get_goods">
					...
					<button class="cart_btn" id="btn_add" role="button"><a href="/order/cart"></a></button>
				</div>
				<!-- 장바구니 버튼 끝 -->        
            </div>                    
            </div>
      ...
      <div class="deatil_view">
         ...
         <div class="IntroImg">
            <img src='<c:out value="${detail.goodsIntroImgUrl}"/>'/>
         </div>
         <div class="explain">
         ...
         <div class="ckPointImg">
            <img src='<c:out value="${detail.ckPointImgUrl}"/>'/>
         ...
         <br>
         <div class="DetailImg">
            <img src='<c:out value="${detail.goodsDetailImgUrl}"/>'/>
         ...
         <br>
         <div class="PickImg">
            <img src='<c:out value="${detail.goodsPickImgUrl}"/>'/>
